...
#include "aclnn_arg_max_with_value.h"
...
TensorDesc outputDesc0_3[2] =
    {{ge::DT_INT32, ge::FORMAT_ND},
     {ge::DT_UINT8, ge::FORMAT_ND}};
SupportInfo list0_0 = {inputDesc0_0, 1, outputDesc0_0, 2};
SupportInfo list0_1 = {inputDesc0_1, 1, outputDesc0_1, 2};
SupportInfo list0_2 = {inputDesc0_2, 1, outputDesc0_2, 2};
SupportInfo list0_3 = {inputDesc0_3, 1, outputDesc0_3, 2};
...
[[maybe_unused]] uint32_t NNOPBASE_ArgMaxWithValue = 0U;
} // namespace
    ...
    aclOpExecutor **executor)
{
    ...
    static NnopbaseDfxId tilingId = {0x60000, "aclnnArgMaxWithValueTiling", false};
    void *nnopExecutor;
    static void *executorSpace = NULL;
    const char *opType = "ArgMaxWithValue";
    char inputDesc[] = {1};
    char outputDesc[] = {1, 1};
    char attrDesc[] = {1, 0};

    NNOPBASE_ASSERT_NOTNULL_RETVAL(x);
    NNOPBASE_ASSERT_NOTNULL_RETVAL(indiceOut);
    NNOPBASE_ASSERT_NOTNULL_RETVAL(valuesOut);
    ...
    *executor = reinterpret_cast<aclOpExecutor *>(nnopExecutor);
    ...
    NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddAttrWithDtype(*executor, static_cast<void*>(&dimension), sizeof(int64_t), 0, kNnopbaseInt));
    NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddAttrWithDtype(*executor, static_cast<void*>(&keepDimsOptional), sizeof(bool), 1, kNnopbaseBool));
    NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddOutput(*executor, indiceOut, 0));
    NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddOutput(*executor, valuesOut, 1));
    if (NnopbaseAddParamName != NULL) {
        NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddParamName(*executor, 0, "x", true));
        NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddParamName(*executor, 0, "indiceOut", false));
        NNOPBASE_ASSERT_OK_RETVAL(NnopbaseAddParamName(*executor, 1, "valuesOut", false));
    }
